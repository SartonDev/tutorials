...
Начнем урок с GET. Как работает метод GET?
...
Для проверки кода рекомендую использовать бесплатный интерпритатор, очень похожий по тематике на Github: replit.com 
